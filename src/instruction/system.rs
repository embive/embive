...
const ECALL_IMM: i32 = 0b0;
const EBREAK_IMM: i32 = 0b1;
const WFI_IMM: i32 = 0b1_0000_0101;
const MRET_IMM: i32 = 0b11_0000_0010;

const EBREAK_ECALL_WFI_MRET_FUNCT3: u8 = 0b000;
...
impl<M: Memory> Instruction<M> for System {
    ...
    fn decode_execute(data: u32, engine: &mut Engine<'_, M>) -> Result<EngineState, Error> {
        ...
        let ret = if inst.funct3 == EBREAK_ECALL_WFI_MRET_FUNCT3 {
            match inst.imm {
                ...
                MRET_IMM => {
                    ...
                    return Ok(EngineState::Running); // Do not increment the program counter
                }
